...
score = np.load(path +
                '/robotics-lab-project/proof_of_concept/reach/data/score_history.npy',
                allow_pickle=False)
avg = np.load(path +
              '/robotics-lab-project/proof_of_concept/reach/data/avg_history.npy',
              allow_pickle=False)
